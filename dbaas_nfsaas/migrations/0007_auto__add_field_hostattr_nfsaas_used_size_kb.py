...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostAttr.nfsaas_used_size_kb'
        db.add_column(u'dbaas_nfsaas_hostattr', 'nfsaas_used_size_kb',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostAttr.nfsaas_used_size_kb'
        db.delete_column(u'dbaas_nfsaas_hostattr', 'nfsaas_used_size_kb')
