...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostAttr.nfsaas_path_host'
        db.add_column(u'dbaas_nfsaas_hostattr', 'nfsaas_path_host',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostAttr.nfsaas_path_host'
        db.delete_column(u'dbaas_nfsaas_hostattr', 'nfsaas_path_host')
